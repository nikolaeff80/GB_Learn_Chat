...
from chatserver.сhatserver.Mainlib.variables import DESTINATION, SENDER, ACTION, PRESENCE, TIME, USER, MESSAGE_TEXT, \
	RESPONSE_200, RESPONSE_400, ERROR, ACCOUNT_NAME, GET_CONTACTS, RESPONSE_202, LIST_INFO, EXIT, ADD_CONTACT, \
	REMOVE_CONTACT, USERS_REQUEST, PUBLIC_KEY_REQUEST, RESPONSE_511, DATA, MESSAGE, RESPONSE, \
	PUBLIC_KEY, RESPONSE_205
